package com.slackintegration.webhooks.slack;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.slackintegration.webhooks.models.RichMessage;
import  com.slackintegration.webhooks.models.Attachment;
...
public class SlackWebhooks {
    ...
    public void invokeSlackWebhook() {
        ...
        RichMessage richMessage = new RichMessage("testing the Slack's incoming webhooks.");
        // set attachments
        Attachment[] attachments = new Attachment[1];
        attachments[0] = new Attachment();
        attachments[0].setText("user date");
